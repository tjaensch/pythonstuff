...
class Testsamos(unittest.TestCase):
    ...
    def test_add_to_ncml(self):
        ...
        data = file.read()
        self.assertTrue(
            "<title>WTEJ_20100808v30001</title><filesize>146</filesize><path>coaps/samos/WTEJ/2010/08/</path></netcdf>" in data)

    def test_xsltproc_to_iso(self):
        file = open("./iso_xml/WTEJ_20100808v30001.xml", "r")
        data = file.read()
        self.assertTrue("gov.noaa.nodc:0156189.WTEJ_20100808v30001" in data)
