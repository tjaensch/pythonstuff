...
class CMAN:
	...
	def __init__(self):
        ...
        def xsltproc_to_iso(self, ncFile):
            xslFile = "/nodc/users/tjaensch/xsl.git/goes/XSL/ncml2iso_modified_from_UnidataDD2MI_GOES_Thomas_edits.xsl"
        ...
        def add_collection_metadata(self, ncFile):
            ...
            granule = "/nodc/users/tjaensch/xsl.git/goes/XSL/granule.xsl"
