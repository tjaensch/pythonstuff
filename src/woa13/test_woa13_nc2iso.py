...
class TestWOA13(unittest.TestCase):
    ...
    def test_ncdump(self):
        self.assertTrue(os.path.isfile("/nodc/users/tjaensch/python.git/src/woa13/ncml/woa13_all_i00_01.ncml"))

    def test_add_to_ncml(self):
        file = open("/nodc/users/tjaensch/python.git/src/woa13/ncml/woa13_all_i00_01.ncml", "r")
        data = file.read()
    ...
    def test_xsltproc_to_iso(self):
        file = open("/nodc/users/tjaensch/python.git/src/woa13/iso_xml/woa13_all_i00_01.xml", "r")
        data = file.read()
        self.assertTrue("WOA13.woa13_all_i00_01" in data)

    def test_add_collection_metadata(self):
        file = open("/nodc/users/tjaensch/python.git/src/woa13/final_xml/woa13_all_i00_01.xml", "r")
        data = file.read()
